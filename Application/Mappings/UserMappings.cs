...
public class UserMappings : Profile
{
    ...
    private void CreateUserMappings()
    {
        CreateMap<UserRequest, ApplicationUser>()
            ...
            .ForMember(d => d.SecurityStamp, o => o.MapFrom(s => Guid.NewGuid().ToString()))
            .ForMember(d => d.ConcurrencyStamp, o => o.MapFrom(s => Guid.NewGuid().ToString()))
            .ForMember(d => d.LockoutEnabled, o => o.MapFrom(s => false))
